<template>
    <div class="center">
        ...
        <div
            class="icon-block--undo"
            title="撤回"
            @click="editorBoard.history.undo()"
        >
            <UndoIcon></UndoIcon>
        </div>
        <div
            class="icon-block--redo"
            title="重做"
            @click="editorBoard.history.redo()"
        >
            <RedoIcon></RedoIcon>
        </div>
...
const exportBoard = () => {
    props.editorBoard.app.tree.syncExport("leafer.png", {
        pixelRatio: 3,
        screenshot: false,
        fill: "#ffffff",
        quality: 0.9,
